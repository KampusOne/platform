...
const createStyles = (theme: Theme) => StyleSheet.create({
  ...
  bodyRegion: { minHeight: 22 }, body: { color: theme.text, fontFamily: theme.font.body, fontSize: 14, lineHeight: 20 }, image: { width: "100%", aspectRatio: 1.5, borderRadius: 12, marginTop: 7 }, deleted: { color: theme.textMuted, fontFamily: theme.font.body, fontSize: 13, fontStyle: "italic", paddingVertical: 5 }, commentActions: { flexDirection: "row", alignItems: "center", gap: 14, flexWrap: "wrap", minHeight: 40 }, replyButton: { flexDirection: "row", alignItems: "center", gap: 5, minHeight: 40, minWidth: 40 }, replyText: { fontFamily: theme.font.body, color: theme.textMuted, fontSize: 11 },
