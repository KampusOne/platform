...
export default function StudentProfile(){
  ...
  const button=(title:string,onPress:()=>void,disabled=false)=><Pressable accessibilityRole="button" accessibilityState={{disabled}} disabled={disabled} onPress={onPress} style={{paddingHorizontal:19,paddingVertical:11,borderRadius:22,backgroundColor:theme.deepBrand,opacity:disabled?0.5:1}}><Text style={{fontFamily:theme.font.semibold,color:"#FFFFFF",fontSize:13}}>{title}</Text></Pressable>;
