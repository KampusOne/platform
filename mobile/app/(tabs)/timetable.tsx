  ...
  async function add() {
    ...
    try {
      ...
      try {
        ...
        /* Saving a class must not be undone by a device permission failure. */
      }
    } catch (caught) {
      setError(
        caught instanceof ApiError
  ...
  async function remove(id: string) {
    ...
    try {
      ...
      try {
        ...
        /* Reconcile when the alarms screen is opened. */
      }
    } catch (caught) {
      setError(
        caught instanceof ApiError
  ...
  return (
    <ProductScreen>
          ...
          return (
            ...
            >
              ...
              <View
                style={[
                  styles.todayDot,
                  today && styles.todayDotVisible,
                  today && selected && styles.todayDotActive,
                ]}
              />
            </Pressable>
          );
      ...
      {!loading && !error && visible.length === 0 ? (
        <ScheduleEmpty day={selectedDay.long} />
      ) : null}
              ...
              <View style={styles.classBlock}>
                ...
                <View style={styles.reminderRow}>
                  <Ionicons
                    ...
                    size={15}
                    color={
                      entry.reminder_enabled ? theme.deepBrand : theme.textMuted
                    }
                  />
                  <Text
                    style={[
                      styles.reminderText,
                      entry.reminder_enabled && styles.reminderOn,
                    ]}
                  >
                    {entry.reminder_enabled
      ...
      <ToolButton
        ...
        onPress={() => router.push("/timetable-import")}
      />
      <ToolButton
        secondary
        label="Manage alarms"
...
function ErrorNotice({
  ...
  return (
    <View accessibilityRole="alert" style={styles.errorNotice}>
      ...
      <Pressable
        accessibilityLabel="Retry timetable"
        accessibilityRole="button"
        onPress={onRetry}
...
const createStyles = (theme: Theme) =>
  StyleSheet.create({
    ...
    dayActive: {
      ...
      borderColor: "rgba(168,70,46,0.28)",
    },
    dayText: {
      color: theme.textMuted,
