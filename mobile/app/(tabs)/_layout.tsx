...
const primaryItems = [
  ...
  },
  {
    ...
    activeIcon: "newspaper" as IconName,
  },
  {
    name: "explore",
    label: "Explore",
    icon: "compass-outline" as IconName,
    activeIcon: "compass" as IconName,
  },
  {
    name: "map",
    label: "Map",
    icon: "map-outline" as IconName,
    activeIcon: "map" as IconName,
  },
  {
    name: "profile",
    label: "Profile",
          ...
          return (
            <NavItem
              ...
              onPress={() => {
                ...
                if (routeName !== route.name && !event.defaultPrevented)
...
const createStyles = (theme: Theme) =>
  StyleSheet.create({
    ...
    navPill: {
      backgroundColor: "rgba(233,177,142,0.27)",
      borderRadius: 21,
      height: 54,
      position: "absolute",
      top: 4,
